      ...
      <div className="el-v5">
        <section className="v5-hero">
          ...
          <div className="v5-hero-ticker" aria-label="Easy License principles">
            <div>
              <span>10,000+ human-made tracks</span><i>●</i><span>Zero AI-generated music</span><i>●</i><span>Every track by a real artist</span><i>●</i><span>Artists paid directly</span><i>●</i><span>Clear licensing for creators and brands</span><i>●</i>
              <span aria-hidden="true">10,000+ human-made tracks</span><i aria-hidden="true">●</i><span aria-hidden="true">Zero AI-generated music</span><i aria-hidden="true">●</i><span aria-hidden="true">Every track by a real artist</span><i aria-hidden="true">●</i><span aria-hidden="true">Artists paid directly</span><i aria-hidden="true">●</i><span aria-hidden="true">Clear licensing for creators and brands</span><i aria-hidden="true">●</i>
            </div>
          </div>
        </section>
        ...
        <section className="v5-proof-band" aria-label="Easy License catalogue in numbers" data-reveal="group">
          ...
          <article className="v5-proof-stat v5-proof-stat-uses">
            <strong>Every brief</strong>
            <span>Creator to campaign</span>
            <small>Video · live · podcast · social · film · game</small>
          </article>
        </section>
