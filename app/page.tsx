    ...
    <PublicShell>
      <section className="hero section-shell motion-hero">
        ...
        <div className="hero-copy">
          <div className="eyebrow" data-reveal="up"><span>✦</span> Independent platform · Powered by Lofi Girl</div>
      ...
      <section className="section section-shell creator-section">
        ...
        <div className="legacy-note" data-reveal="up"><span>◇</span><p><strong>Already approved before Easy License?</strong>A valid legacy permission stays protected under its original terms. New channels or uses can move into Easy License when needed.</p><Link href="/pricing#faq">How legacy permissions work →</Link></div>
      </section>
      ...
      <section className="section section-shell sync-teaser">
        <div className="sync-teaser-inner" data-pointer-glow="">
          <div data-reveal="left"><span className="section-kicker">FOR BRANDS & PRODUCTIONS</span><h2>Existing track or<br />something made for you?</h2><p>Both start with the same brief. Our licensing team helps you choose the right path.</p></div>
          <div className="sync-paths" data-reveal="group"><div><span>♫</span><p><strong>License existing music</strong><small>Clear a track from the eligible catalogue for a campaign, film, game or branded project.</small></p></div><i>OR</i><div><span>✦</span><p><strong>Commission custom music</strong><small>Original composition, sonic identity and production made by real artists.</small></p></div></div>
          <Link className="button button-light" href="/sync" data-reveal="up">Start a project brief <span>→</span></Link>
        </div>
      </section>

      <section className="section section-shell faq-section" id="faq">
        <div className="section-heading centered small-heading" data-reveal="up"><span className="section-kicker">THE IMPORTANT BITS</span><h2>Clear answers, before<br />you press publish.</h2></div>
        ...
        <Link className="text-link arrow-link faq-more" href="/pricing#faq" data-reveal="up">Read the full licence FAQ →</Link>
      </section>
