      ...
      sections={[
        {
          ...
          content: (
            <>
              ...
              <p className="support-notice">Symbiome is presented as an independent product powered by <LofiGirlWordmark className="lofi-girl-wordmark-inline" />.</p>
            </>
          ),
        },
        {
        ...
        },
        {
          ...
          content: (
            <>
              <p>The relationship is stated directly in the Symbiome identity: Symbiome is an independent product powered by <LofiGirlWordmark className="lofi-girl-wordmark-inline" />. The service extends a music and artist ecosystem already recognised for instrumental listening into practical licensing for people making content and commercial work.</p>
              <p>Official <LofiGirlWordmark className="lofi-girl-wordmark-inline" /> music, livestreams and releases remain available through <a href="https://www.lofigirl.com/" target="_blank" rel="noreferrer">lofigirl.com</a>.</p>
            </>
          ),
        },
        {
          ...
          content: (
            <>
              <p>For a press request concerning Symbiome or the wider <LofiGirlWordmark className="lofi-girl-wordmark-inline" /> universe, use the <a href="https://www.lofigirl.com/contact" target="_blank" rel="noreferrer">official <LofiGirlWordmark className="lofi-girl-wordmark-inline" /> contact form</a>. Include the publication, subject, deadline and the format of the request.</p>
