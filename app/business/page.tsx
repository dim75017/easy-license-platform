      ...
      <div className="offer-landing business-landing">
        <section className="offer-hero offer-hero-business">
          <div className="offer-hero-copy" data-reveal="left">
            <p className="offer-kicker offer-lofi-signature"><span>SYMBIOME / BUSINESS</span><span className="offer-powered-lockup"><span className="offer-powered-label">Powered by</span><LofiGirlWordmark /></span></p>
