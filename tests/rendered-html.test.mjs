...
test("keeps the connected workspace readable and artist-led", async () => {
  ...
  assert.match(musicWorkspaceV13, /\.music-player-wave \.music-wave\s*\{[^}]*display:\s*block;[^}]*width:\s*100%;[^}]*min-width:\s*0;[^}]*height:\s*18px;[^}]*color:\s*var\(--wm-ink\)/s);
  ...
  assert.ok(v13TabletStart >= 0 && v13MediumStart > v13TabletStart && v13CompactStart > v13MediumStart && v13PhoneStart > v13CompactStart && v13ForcedColoursStart > v13PhoneStart);
