...
test("keeps the connected workspace readable and artist-led", async () => {
  ...
  assert.match(musicWorkspace, /const count = dense \? 96 : 24/);
  ...
  assert.match(musicWorkspaceV13, /\.music-player-wave \.music-wave\s*\{[^}]*height:\s*18px;[^}]*justify-content:\s*space-between;[^}]*gap:\s*0/s);
  assert.match(musicWorkspaceV13, /\.music-player-wave \.music-wave i\s*\{[^}]*width:\s*1\.5px;[^}]*max-width:\s*1\.5px;[^}]*flex:\s*0 0 1\.5px;[^}]*border-radius:\s*1px/s);
  ...
  assert.match(musicWorkspaceV13, /\.workspace-player-timeline\s*\{[^}]*grid-template-columns:\s*34px minmax\(160px, 1fr\) 34px/s);
  assert.match(musicWorkspaceV13, /\.workspace-player-timeline \.music-player-wave \.music-wave\s*\{[^}]*height:\s*20px;[^}]*color:\s*var\(--wm-cream\)/s);
  ...
  assert.ok(v13TabletStart >= 0 && v13MediumStart > v13TabletStart && v13CompactStart > v13MediumStart && v13PhoneStart > v13CompactStart && v13ReducedMotionStart > v13PhoneStart && v13ForcedColoursStart > v13ReducedMotionStart);
  const v13TabletCss = musicWorkspaceV13.slice(v13TabletStart, v13MediumStart);
  ...
  assert.match(v13PhoneCss, /\.workspace-player-timeline\s*\{[^}]*grid-template-columns:\s*30px minmax\(72px, 1fr\) 30px/s);
