  ...
  await database
    .prepare(
      ...
      ON CONFLICT(batch_key, source_key) DO UPDATE SET
        ...
        owner_attestation_sha256 = excluded.owner_attestation_sha256,
        catalogue_scope_sha256 = excluded.catalogue_scope_sha256,
        selection_sha256 = excluded.selection_sha256,
        master_inspection_sha256 = excluded.master_inspection_sha256,
        master_read_complete = excluded.master_read_complete,
    ...
    .bind(
      ...
      item.catalogOwnerEvidence?.ownerAttestationSha256 ?? null,
      item.catalogOwnerEvidence?.catalogueScopeSha256 ?? null,
      item.catalogOwnerEvidence?.selectionSha256 ?? null,
      item.catalogOwnerEvidence?.masterInspectionSha256 ?? null,
      item.catalogOwnerEvidence?.masterReadComplete ? 1 : null,
      item.title,
      item.artistCredit,
      item.durationMs,
    )
